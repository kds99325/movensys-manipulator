...
Loads defaults from config/yolo_dice_detector.yaml. The `model_path`
...
def generate_launch_description():
    ...
    default_params = os.path.join(pkg_share, 'config', 'yolo_dice_detector.yaml')
    default_model = os.path.join(pkg_share, 'models', 'dice_obb.pt')
