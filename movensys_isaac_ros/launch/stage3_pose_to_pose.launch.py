...
def generate_launch_description():
    ...
    # Stage2 nvblox node with MoveIt parameters
    stage2_nvblox_node = Node(
        package="movensys_isaac_ros",
        executable="stage3_pose_to_pose_cpp",
        name="stage3_pose_to_pose_cpp",
        output="screen",
        parameters=[
    ...
    return LaunchDescription(declared_arguments + [stage2_nvblox_node])
