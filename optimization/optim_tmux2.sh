...
# 3. Pane 0.0: Gazebo 실행
tmux new-session -d -s $SESSION -n "trajectory_test"
tmux send-keys -t $SESSION:0.0 \
    "mros ros2 launch movensys_manipulator_description gazebo_trajectory_simulation.launch.py" C-m
...
tmux send-keys -t $SESSION:0.3 \
    ...
    echo \"[Ready! Starting Keyboard Teleop...]\"; \
     ros2 run movensys_manipulator_moveit_config keyboard_teleop --ros-args -p use_sim_time:=true'" C-m
